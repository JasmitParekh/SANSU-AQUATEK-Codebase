function generateFormsFromAttendanceSlip() {
  ...
  const config = {
    formatSpreadsheetId: '19Aav-aOksAKaqzoyezX5BXOdxePhAewJkYiIqiWrHzk',
      ...
      form17: {
        columns: [
          ...
          },
          {
            type: 'formula',
            header: 'PF',
            formula: '=MIN(({Basic Wages}+{Payments P.H.}+{Conve.}+{Site Allowances}+{Wash Allowance}+{FINE})*12%, 1800)'
          },
          {
            type: 'formula',
            header: 'Others (PT)',
