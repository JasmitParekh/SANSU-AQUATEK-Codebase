 ...
 */
function combineGodrejValiaForms(dates = 1) {
  const ui = SpreadsheetApp.getUi();
  const response = ui.alert('COMBINE SHEETS', 'WOULD YOU LIKE TO COMBINE SHEETS OF FORM-16 AND 17?', ui.ButtonSet.OK_CANCEL);
  ...
  const folderId = getMonthFolderId('Godrej Valia', dates);
  ...
  // Combine Form-16 (Attendance Register)
  combineForm16(folderId);
  
  // Combine Form-17 (Wages Register)
  combineForm17(folderId);
 ...
 */
function combineGodrejValia_CurrentMonth() {
  combineGodrejValiaForms(0);
}

/**
 * Combine forms for PREVIOUS month (shortcut)
 */
function combineGodrejValia_PreviousMonth() {
  combineGodrejValiaForms(1);
}
 ...
 * Combine Form-16: Attendance Register
 */
function combineForm16(folderId) {
  const config = {
    folderId: folderId,
    outputFileName: '5. Form-16: Attendance Register',
    sourceFileNames: [
      '5. Form-16: Attendance Register (CPP)',
      '5. Form-16: Attendance Register (B.B. - 3)',
      '5. Form-16: Attendance Register (B.B. - 4)',
      '5. Form-16: Attendance Register (RO/MEE)'
    ],
    worksheetNames: ['CPP', 'B.B. - 3', 'B.B. - 4', 'RO/MEE']
  };

  combineMultipleSheetsIntoOne(config);
}

/**
 * Combine Form-17: Wages Register
 */
function combineForm17(folderId) {
  const config = {
    folderId: folderId,
    outputFileName: '6. Form-17: Wages Register',
    sourceFileNames: [
      '6. Form-17: Wages Register (CPP)',
      '6. Form-17: Wages Register (B.B. - 3)',
      '6. Form-17: Wages Register (B.B. - 4)',
      '6. Form-17: Wages Register (RO/MEE)'
    ],
    worksheetNames: ['CPP', 'B.B. - 3', 'B.B. - 4', 'RO/MEE']
  };
 ...
 */
function combineMultipleSheetsIntoOne(config) {
