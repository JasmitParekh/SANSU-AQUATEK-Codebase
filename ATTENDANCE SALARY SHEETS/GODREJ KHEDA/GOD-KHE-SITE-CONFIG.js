const SITE_CONFIG = {
  siteName: 'GODREJ INDUSTRIES - KHEDA',                                         // This must match with EMPLOYEE DETAILS SHEET
  siteFolderName: 'Godrej Kheda',                                                // Folder name of the Site
  attendanceSalarySheetID: '1dNQZq398LFy76kzpWN4733zdtns9LjJoBgtq6Mt-FMU',       // ID of Attendance_Salary_Sheet
  dates: 0,                                                                      // 0 for previous month, 1 for current month

  // Form-A to Form-23 IDs (Form-14 and Form-18 not included)
  formatTemplateID: '1n_g0HBKhTWvnin7VTm6UvHxPqg3qpDKAfshLQtaQs_0',              // ID of format spreadsheet which contains formats of Form-A to 23
  ...
  // Form-14 IDs
  form14TemplateID: '1qAMPDLInUx11zFU_ftS5mL8ERNqRjJQ6-bEG_C1ON4Y',              // ID of Form-14 Template
  ...
  // Payment Slip IDs
  paySlipTemplateID: '1cVmWs3UrpTrKc-VsbJisMzibqQX95IS6TxJ_oT9sK9w',             // ID of Payment SLip Template
