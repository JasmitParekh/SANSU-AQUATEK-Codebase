 function generateForm23WithDepartmentsGodrejKheda(){
...
function generateForm23(departmentName) {
  ...
  categories.forEach(category => {                                                // This should match with the category column in Attendance_Salary_Sheet.
    generateForm23WithCategoryFilterGodrejKheda(baseConfig, category);
  })
}

function generateForm23WithCategoryFilterGodrejKheda(baseConfig, category){
