function generateFormsFromAttendanceSlip() {
  ...
  const config = {
    formatSpreadsheetId: '18JS9nqOiK-9UE3oKY4zOq3u89BpKYVRDPt0IkJFOgAU',
      ...
      form17: {
        columns: [
          ...
          'Wash Allowance',
          {
            type: 'formula',
            header: 'Total',
            formula: '={Basic Wages}+{Payments Overtime}+{Payments P.H.}+{HRA}+{Conve.}+{Site Allowances}+{Wash Allowance}'
          },
          {
            type: 'formula',
            header: 'PF',
            formula: '=MIN(({Basic Wages}+{Payments P.H.}+{Conve.}+{Site Allowances}+{Wash Allowance})*12%, 1800)'
          },
          'ESIC 0.75%',
          {
            type: 'formula',
          ...
          'Advance',
          {
            type: 'formula',
            header: 'Net Payment',
            formula: '={Total}-{PF}-{ESIC}-{Others (PT)}-{Advance}'
          },
          { type: 'empty' },
